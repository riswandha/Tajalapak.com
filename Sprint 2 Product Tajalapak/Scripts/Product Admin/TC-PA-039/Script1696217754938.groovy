...
WebUI.click(findTestObject('Product Admin/TambahProduk/Keterangan/Button Help Kolom Keterangan'))

WebUI.verifyElementPresent(findTestObject('Product Admin/TambahProduk/Keterangan/Verifikasi halaman Help Kolom Keterangan'), 
    0)
