...
WebUI.setText(findTestObject('Product Admin/TambahProduk/Keterangan/Input Link Image'), 'gambar')

WebUI.click(findTestObject('Product Admin/TambahProduk/Keterangan/Button Insert Image'))

WebUI.verifyElementNotPresent(findTestObject('Product Admin/TambahProduk/Keterangan/img via Link'), 0)
