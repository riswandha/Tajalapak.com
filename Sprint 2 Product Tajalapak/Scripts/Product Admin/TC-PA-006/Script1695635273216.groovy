...
WebUI.callTestCase(findTestCase('Product Admin/TC-PA-005'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Product Admin/Button Sort Nama Produk'))

//ambil semua element
List<WebElement> dataList = WebUI.findWebElements(findTestObject('Object Repository/Product Admin/Data Nama Produk'), 10)
