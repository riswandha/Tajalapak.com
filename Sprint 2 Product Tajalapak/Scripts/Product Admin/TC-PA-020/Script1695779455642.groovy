...
WebUI.callTestCase(findTestCase('Product Admin/TC-PA-019'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Product Admin/Button Sort Product NoOrYes'))

//ambil semua element
List<WebElement> dataList = WebUI.findWebElements(findTestObject('Object Repository/Product Admin/Data Product Aktif Or Tidak'), 10)
