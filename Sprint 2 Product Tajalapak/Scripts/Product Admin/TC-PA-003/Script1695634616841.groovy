...
//deklaasi dua array
String[] arrProdukNoOri = new String[dataList.size()]
String[] arrProdukNoSort = new String[dataList.size()]

//deklarasi dua array
for(int i = 0 ; i<dataList.size(); i++) {
	text = dataList.get(i).text
	arrProdukNoOri[i] = text
	arrProdukNoSort[i] = text
}

//sort array
Arrays.sort(arrProdukNoSort,Collections.reverseOrder())
