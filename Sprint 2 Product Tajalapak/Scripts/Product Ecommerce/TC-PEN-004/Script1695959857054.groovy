...
WebUI.setText(findTestObject('Product Ecommerce/Tambahkan Product/Input Stok Awal'), '0')
...
field_username_element = driver.findElement(By.xpath('//input[@name="minimum"]'))
...
assert accept_button_message == "Please Column is not 0"