...
WebUI.setText(findTestObject('Product Ecommerce/Kupon/Input Jumlah Kode kupon'), '-1')
...
field_username_element = driver.findElement(By.xpath('//input[@id="jumlah_kupon"]'))
