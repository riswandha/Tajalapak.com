...
WebUI.click(findTestObject('Product Ecommerce/Tambahkan Product/Button Tambahkan'))
...
field_username_element = driver.findElement(By.xpath('//select[@name="a"]'))
...
assert accept_button_message == "Please select an item in the list."