...
WebUI.setText(findTestObject('Product Admin/TambahProduk/Input Stok Awal'), '5')

WebUI.setText(findTestObject('Product Ecommerce/Tambahkan Product/Input Minimum Order'), '10')

WebUI.click(findTestObject('Product Ecommerce/Tambahkan Product/Button Update Data'))

WebUI.verifyElementNotPresent(findTestObject('Product Ecommerce/Verifikasi Halaman Product Anda'), 0)
