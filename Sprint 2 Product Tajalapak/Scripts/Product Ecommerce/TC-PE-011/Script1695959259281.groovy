...
WebUI.click(findTestObject('Product Ecommerce/Kupon/Button Hapus Data'))

WebUI.verifyElementNotPresent(findTestObject('Product Ecommerce/Kupon/Button Edit Voucher'), 0)
