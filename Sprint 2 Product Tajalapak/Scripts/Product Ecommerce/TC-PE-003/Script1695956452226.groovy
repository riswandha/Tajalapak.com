...
WebUI.verifyElementPresent(findTestObject('Product Ecommerce/Tambahkan Produk'), 0)

WebUI.click(findTestObject('Product Ecommerce/Tambahkan Product/Edit Data'))

WebUI.setText(findTestObject('Product Ecommerce/Tambahkan Product/Input Harga Jual'), hargaBaru)
...
hargaProduct = WebUI.getText(findTestObject('Object Repository/Product Ecommerce/Verifikasi product/Harga Product Ke 1'))

String[] harga = hargaProduct.split(" ")

assert harga[1].replace(",", "") == hargaBaru
