...
WebUI.setText(findTestObject('Product Ecommerce/Kupon/Input Masa Berlaku'), '1945-11-11')
...
field_username_element = driver.findElement(By.xpath('//input[@id="expire_date"]'))
...
assert accept_button_message == "Please input Valid."