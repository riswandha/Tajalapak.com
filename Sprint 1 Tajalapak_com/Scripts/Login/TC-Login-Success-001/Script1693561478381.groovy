...
WebUI.setText(findTestObject('Login/Kolom username'), 'riswandha')

WebUI.setEncryptedText(findTestObject('Login/Kolom password'), 'iGDxf8hSRT4=')

WebUI.click(findTestObject('Login/button_Masuk'))

WebUI.verifyElementPresent(findTestObject('Login/Button Logout'), 0)
