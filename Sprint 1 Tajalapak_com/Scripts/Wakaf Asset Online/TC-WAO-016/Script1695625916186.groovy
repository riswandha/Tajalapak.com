...
WebUI.setText(findTestObject('Wakaf Asset Online/Input Nama Lengkap'), 'a')
...
WebUI.verifyElementText(findTestObject('Wakaf Asset Online/Verify Wakaf Asset Diproses'), 'Nama tidak boleh 1 huruf')
