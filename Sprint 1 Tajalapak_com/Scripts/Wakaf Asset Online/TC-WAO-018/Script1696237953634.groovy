...
WebUI.setText(findTestObject('Wakaf Asset Online/Input Perkiraan Nilai Asset'), '10000000000000000000')
...
WebUI.setText(findTestObject('Wakaf Asset Online/Input Nama Lengkap'), 'Joko')
...
WebUI.verifyElementText(findTestObject('Wakaf Asset Online/Verify Wakaf Asset Diproses'), 'Nilai Perkiraan wakaf asset terlalu besar')
