...
WebUI.uploadFile(findTestObject('Wakaf Asset Online/Input File Upload'), 'E:\\Pelatihan\\Xsis Academy\\Heading.html')
...
WebUI.verifyElementText(findTestObject('Wakaf Asset Online/Verify Wakaf Asset Diproses'), 'Format Tidak Sesuai')
