...
WebUI.setText(findTestObject('Wakaf Asset Online/Input Nama Lengkap'), '~!@#$%^&*()')
...
WebUI.verifyElementNotPresent(findTestObject('Wakaf Asset Online/Verify Wakaf Asset Diproses'), 0)
