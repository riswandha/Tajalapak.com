...
WebUI.selectOptionByValue(findTestObject('Wakaf Asset Online/Pilih Type Wakaf'), 'Lainnya', false)
...
WebUI.uploadFile(findTestObject('Wakaf Asset Online/Input File Upload'), 'E:\\Pelatihan\\Xsis Academy\\DJI_0621.DNG')
...
WebUI.verifyElementText(findTestObject('Wakaf Asset Online/Verify Wakaf Asset Diproses'), 'File Tidak Boleh lebih dari 10 MB')
