...
WebUI.setText(findTestObject('Wakaf Asset Online/Input No Handphone'), '085123456')
...
WebUI.setText(findTestObject('Wakaf Asset Online/Input 2 Digit Terakhir'), '56')

WebUI.click(findTestObject('Wakaf Asset Online/button Wakaf Sekarang'))

WebUI.verifyElementText(findTestObject('Wakaf Asset Online/Verify Wakaf Asset Diproses'), 'Error kurang dari 11 angka')
