...
WebUI.setText(findTestObject('Wakaf Asset Online/Input Nama Lengkap'), 'Adolph Blaine Charles David Earl Frederick Gerald Hubert Irvim John Kenneth Loyd Martin Nero Oliver Paul Quincy Randolph Sherman Thomas Uncas Victor Willian Xerxes Yancy Zeus Wolfeschlegelsteinhausenbergerdorffvoralternwarengewissenhaftschafers')

WebUI.setText(findTestObject('Wakaf Asset Online/Input No Handphone'), '085123456789')

WebUI.setText(findTestObject('Wakaf Asset Online/Input Email'), 'joko@gmailcom')
...
WebUI.verifyElementText(findTestObject('Wakaf Asset Online/Verify Wakaf Asset Diproses'), 'Nama tidak boleh lebih dari 150 huruf')
