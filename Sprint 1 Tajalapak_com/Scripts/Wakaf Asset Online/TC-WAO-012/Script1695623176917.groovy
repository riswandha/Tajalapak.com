...
WebUI.setText(findTestObject('Wakaf Asset Online/Input 2 Digit Terakhir'), '8999')

WebUI.click(findTestObject('Wakaf Asset Online/button Wakaf Sekarang'))

WebUI.verifyElementText(findTestObject('Wakaf Asset Online/Verify_GAGAL Diproses, 2 Digit Terakhir No Handphone'), 'GAGAL Diproses, 2 Digit Terakhir No Handphone yang anda input salah!')
