...
WebUI.setText(findTestObject('Wakaf Asset Online/Input Email'), 'jokogmail.com')
...
field_username_element = driver.findElement(By.xpath('//input[@name="alamat_email"]'))
...
assert accept_button_message == 'Please include an \'@\' in the email address. \'jokogmail.com\' is missing an \'@\'.'
