...
WebUI.setText(findTestObject('Wakaf Asset Online/Input Perkiraan Nilai Asset'), '-1')
...
WebUI.verifyElementText(findTestObject('Wakaf Asset Online/Verify Wakaf Asset Diproses'), 'Nilai Perkiraan wakaf asset Tidak Valid')
