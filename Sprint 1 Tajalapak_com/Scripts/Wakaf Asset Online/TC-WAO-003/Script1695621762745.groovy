...
WebUI.setText(findTestObject('Wakaf Asset Online/Input Perkiraan Nilai Asset'), '1000000')

WebUI.setText(findTestObject('Wakaf Asset Online/Input Alamat Asset'), '')
...
field_username_element = driver.findElement(By.xpath('//input[@name="alamat"]'))
