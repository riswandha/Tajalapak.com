...
WebUI.setText(findTestObject('Wakaf Asset Online/Input No Handphone'), '085123456789011')
...
WebUI.setText(findTestObject('Wakaf Asset Online/Input 2 Digit Terakhir'), '11')

WebUI.click(findTestObject('Wakaf Asset Online/button Wakaf Sekarang'))

WebUI.verifyElementText(findTestObject('Wakaf Asset Online/Verify Wakaf Asset Diproses'), 'Nomor Telepon lebih dari 13 angka')
