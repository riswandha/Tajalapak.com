...
merk_product = WebUI.getText(findTestObject('Object Repository/Search Product/Laptop Merk Dell'))

merkLowercase = merk_product.toLowerCase()

assert merkLowercase.contains(merk.toLowerCase())
